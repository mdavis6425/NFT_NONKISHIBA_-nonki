...
var contractAddress = '0x85a951a87d3d9b339b44d4ff6eaf64c1ca5fc738';
        ...
        if(result!=null)
        {
            if(result.status) {
                ...
                result.logs.forEach((element) => {
                    ...
                    {
                        id = element.topics[1];
                        html = html+ '<a href="https://opensea.io/assets/0x85a951a87d3d9b339b44d4ff6eaf64c1ca5fc738/'+id+'" target="_blank">Go to Newly Minted Nonki Shiba</a>';
                    }
                });
                if(html!="")
                {
